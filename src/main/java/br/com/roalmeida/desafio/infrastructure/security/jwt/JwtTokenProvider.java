package br.com.roalmeida.desafio.infrastructure.security.jwt;
...
import br.com.roalmeida.desafio.application.execptions.AutenticacaoJWTInvalidaException;
...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token) {
        ...
        try {
            ...
            throw new AutenticacaoJWTInvalidaException("Expired or invalid JWT token");
        }
    }
}
